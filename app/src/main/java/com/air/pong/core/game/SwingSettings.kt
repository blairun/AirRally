...
data class SwingSettings(
    ...
    companion object {
        ...
        const val DEFAULT_MEDIUM_FLAT_SHRINK = 15

        const val DEFAULT_HARD_FLAT_NET_RISK = 2
        const val DEFAULT_HARD_FLAT_OUT_RISK = 3
        const val DEFAULT_HARD_FLAT_SHRINK = 30
        ...
        const val DEFAULT_MEDIUM_SMASH_SHRINK = 30

        const val DEFAULT_HARD_SMASH_NET_RISK = 5
        const val DEFAULT_HARD_SMASH_OUT_RISK = 5
        const val DEFAULT_HARD_SMASH_SHRINK = 40

        // Flight Time Modifiers
        const val DEFAULT_SOFT_FLAT_FLIGHT = 1.2f
        const val DEFAULT_MEDIUM_FLAT_FLIGHT = 1.0f
        const val DEFAULT_HARD_FLAT_FLIGHT = 0.8f

        const val DEFAULT_SOFT_LOB_FLIGHT = 1.3f
        const val DEFAULT_MEDIUM_LOB_FLIGHT = 1.5f
        const val DEFAULT_HARD_LOB_FLIGHT = 1.7f

        const val DEFAULT_SOFT_SMASH_FLIGHT = 0.8f
        const val DEFAULT_MEDIUM_SMASH_FLIGHT = 0.7f
        const val DEFAULT_HARD_SMASH_FLIGHT = 0.6f
