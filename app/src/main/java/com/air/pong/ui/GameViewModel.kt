...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // Bonus Mechanics Toggles (all enabled by default)
    private val _bonusSpinEnabled = kotlinx.coroutines.flow.MutableStateFlow(true)
    val bonusSpinEnabled = _bonusSpinEnabled.asStateFlow()
    private val _bonusCopyCatEnabled = kotlinx.coroutines.flow.MutableStateFlow(true)
    val bonusCopyCatEnabled = _bonusCopyCatEnabled.asStateFlow()
    private val _bonusSpecialSquaresEnabled = kotlinx.coroutines.flow.MutableStateFlow(true)
    val bonusSpecialSquaresEnabled = _bonusSpecialSquaresEnabled.asStateFlow()
    private val _bonusPowerOutageEnabled = kotlinx.coroutines.flow.MutableStateFlow(true)
    ...
    init {
        ...
        _isTapToHitEnabled.value = sharedPrefs.getBoolean("tap_to_hit_enabled", false)
        
        // Load Bonus Mechanics Settings (all enabled by default)
        _bonusSpinEnabled.value = sharedPrefs.getBoolean("bonus_spin_enabled", true)
        _bonusCopyCatEnabled.value = sharedPrefs.getBoolean("bonus_copycat_enabled", true)
        _bonusSpecialSquaresEnabled.value = sharedPrefs.getBoolean("bonus_special_squares_enabled", true)
        _bonusPowerOutageEnabled.value = sharedPrefs.getBoolean("bonus_power_outage_enabled", true)
