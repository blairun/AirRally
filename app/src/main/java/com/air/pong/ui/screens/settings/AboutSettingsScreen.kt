...
fun AboutSettingsScreen() {
    ...
    Column(
        ...
        // Changelog (don't add these to strings.xml!)
        Text(
            text = "Changelog (v.${BuildConfig.VERSION_NAME})", 
        ...
        val changes = listOf(
            "Added Rally Mode Bonuses (Spin, Copy Cat, Special Squares, Power Outage)",
            "Added Tutorial and Swing Calibration flows",
            "New Settings including Tap-to-Hit Accessibility Mode",
