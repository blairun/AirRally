...
object AvatarUtils {
    ...
    val RALLY_SCORE_THRESHOLDS = listOf(700, 2800, 4400, 7000, 10000, 13900, 17600, 20300)
    val RALLY_LENGTH_THRESHOLDS = listOf(31, 49, 79, 100, 130, 167, 188, 203)
    val CLASSIC_WINS_THRESHOLDS = listOf(7, 13, 19, 31)
    // for testing
