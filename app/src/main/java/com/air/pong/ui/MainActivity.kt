                    ...
                    NavHost(navController = navController, startDestination = "main_menu") {
                        composable("main_menu") {
                            MainMenuScreen(
                                ...
                                onNavigateToSettings = { screenType, scrollToRings ->
                                    navController.navigate("settings?screen=${screenType.name}&scrollToRings=$scrollToRings")
                                },
                                onNavigateToGame = {
                        ...
                        composable(
                            ...
                            val scrollToRings = backStackEntry.arguments?.getBoolean("scrollToRings") ?: false
                            ...
                            com.air.pong.ui.screens.SettingsScreen(
                                ...
                                onLaunchTutorial = {
                                    // Navigate back to main menu - tutorial will show via ViewModel state
                                    viewModel.requestTutorialFromSettings()
    ...
    override fun onResume() {
        ...
        if (volumePercent < 0.5f) {
            ...
            val textView = android.widget.TextView(this).apply {
                text = getString(R.string.volume_toast)
