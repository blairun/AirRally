...
fun MainMenuScreen(
    ...
    // New avatar unlock notification banner - rendered last so it's on top and clickable
    if (hasNewAvatarUnlock) {
        Box(
            modifier = Modifier
            ...
            Card(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.new_avatar_unlocked),
