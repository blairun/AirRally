            ...
            AnimatedContent(
                ...
                when (targetScreen) {
                    ...
                    SettingsScreenType.GameParams -> GameParamsSettingsScreen(
                        ...
                        onSettingsChange = {
                            viewModel.updateSettings(flightTime.toLong(), difficulty, isDebugMode, gameState.useDebugTones, minSwingThreshold, gameState.isRallyShrinkEnabled, gameState.gameMode)
                        },
                    ...
                    SettingsScreenType.Debug -> DebugSettingsScreen(
                        ...
                        onUseDebugTonesChange = {
                            viewModel.updateSettings(flightTime.toLong(), difficulty, isDebugMode, it, minSwingThreshold, gameState.isRallyShrinkEnabled, gameState.gameMode)
                        },
                        minSwingThreshold = minSwingThreshold,
                        lastSwingType = gameState.lastSwingType,
                        lastSwingData = gameState.lastSwingData,
