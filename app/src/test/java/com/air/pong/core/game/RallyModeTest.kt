...
class RallyModeTest {
    ...
    fun `test shared scoring with individual grids`() {
        ...
        assertEquals("Score should be tier-0 points after serve", 1, state.rallyScore)
        ...
        assertEquals("Score after serve + opponent hit", 2, state.rallyScore)
        ...
        assertEquals("Total should be 3 (1 from serve + 1 from opponent + 1 from me)", 3, state.rallyScore)
    }
