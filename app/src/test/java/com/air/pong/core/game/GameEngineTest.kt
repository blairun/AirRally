...
class GameEngineTest {
    ...
    fun `test timing window`() {
        ...
        gameEngine.updateSettings(testFlightTime, 500, isDebugMode = false, useDebugTones = false, softThreshold = GameEngine.DEFAULT_SOFT_THRESHOLD, mediumThreshold = GameEngine.DEFAULT_MEDIUM_THRESHOLD, hardThreshold = GameEngine.DEFAULT_HARD_THRESHOLD, isRallyShrinkEnabled = true) // Difficulty 500ms (Medium)
        ...
        gameEngine.processSwing(serveTime, 25f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f) 
    ...
    fun `test flight time modifiers`() {
        ...
        gameEngine.updateSettings(baseFlightTime, 500, isDebugMode = false, useDebugTones = false, softThreshold = GameEngine.DEFAULT_SOFT_THRESHOLD, mediumThreshold = GameEngine.DEFAULT_MEDIUM_THRESHOLD, hardThreshold = GameEngine.DEFAULT_HARD_THRESHOLD, isRallyShrinkEnabled = true)
    ...
    fun `test smash serve flight time exception`() {
        ...
        val baseFlightTime = 1000L
        gameEngine.updateSettings(baseFlightTime, 500, false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, true)
        ...
        val timestamp = 1000L
        val result = gameEngine.processSwing(timestamp, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, -6.0f)
    ...
    fun `test no window shrink on serve return`() {
        ...
        val baseWindow = 500L
        gameEngine.updateSettings(1000L, baseWindow.toInt(), false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, true, GameMode.CLASSIC)
        gameEngine.startGame()
        
        // Serve HARD_SMASH (Shrink is normally high, e.g. 50%)
        gameEngine.processSwing(1000L, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, -6.0f)
    ...
    fun `test fast smash hit window`() {
        ...
        val difficulty = 500
        gameEngine.updateSettings(baseFlightTime, difficulty, false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, true, GameMode.CLASSIC)
    ...
    fun `test window shrink`() {
        ...
        val testFlightTime = 1000L
        gameEngine.updateSettings(testFlightTime, 500, isDebugMode = false, useDebugTones = false, softThreshold = GameEngine.DEFAULT_SOFT_THRESHOLD, mediumThreshold = GameEngine.DEFAULT_MEDIUM_THRESHOLD, hardThreshold = GameEngine.DEFAULT_HARD_THRESHOLD, isRallyShrinkEnabled = true, gameMode = GameMode.CLASSIC) // Difficulty 500ms
        val baseWindow = 500L
    ...
    fun `test risk logic`() {
        ...
        try {
            ...
            repeat(100) { index ->
                ...
                val result = gameEngine.processSwing(timestamp, 10f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
                assertEquals(HitResult.HIT, result)
            }
            ...
            repeat(100) { 
                ...
                val result = engine.processSwing(1000L, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, -6.0f)
    ...
    fun `test risk probabilities`() {
        ...
        repeat(iterations) {
            ...
            var result = engine.processSwing(1000L, 25f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
            if (result == HitResult.PENDING) {
        ...
        repeat(iterations) {
            ...
            var result = engine.processSwing(1000L, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
            if (result == HitResult.PENDING) {
                result = engine.resolvePendingMiss()
            }
        ...
        repeat(iterations) {
            ...
            var result = engine.processSwing(1000L, 10f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, -6.0f)
            if (result == HitResult.PENDING) {
                result = engine.resolvePendingMiss()
            }
        ...
        repeat(iterations) {
            ...
            var result = engine.processSwing(1000L, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, -6.0f)
            if (result == HitResult.PENDING) {
                result = engine.resolvePendingMiss()
            }
    ...
    fun `test dynamic swing threshold`() {
        ...
        gameEngine.updateSettings(1000L, 500, false, false, 10.0f, 19.0f, 40.0f, true)
        ...
        gameEngine.startGame()
        gameEngine.processSwing(1000L, 11.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.SOFT_FLAT, gameEngine.gameState.value.lastSwingType)
        
        // 2. MEDIUM (Force=20.0) -> > 10.0 + 9.0 = 19.0
        gameEngine.processSwing(2000L, 20.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.MEDIUM_FLAT, gameEngine.gameState.value.lastSwingType)
        
        // 3. HARD (Force=41.0) -> > 10.0 + 30.0 = 40.0
        gameEngine.processSwing(3000L, 41.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.HARD_FLAT, gameEngine.gameState.value.lastSwingType)
        
        // Set default threshold (14.0f)
        gameEngine.updateSettings(1000L, 500, false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, true)

        // 4. SOFT (Force=20.0) -> > 14.0 (but < 23.0)
        gameEngine.processSwing(4000L, 20.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.SOFT_FLAT, gameEngine.gameState.value.lastSwingType)

        // 5. MEDIUM (Force=24.0) -> > 14.0 + 9.0 = 23.0
        gameEngine.processSwing(5000L, 24.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.MEDIUM_FLAT, gameEngine.gameState.value.lastSwingType)

        // 6. HARD (Force=45.0) -> > 14.0 + 30.0 = 44.0
        gameEngine.processSwing(6000L, 45.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.HARD_FLAT, gameEngine.gameState.value.lastSwingType)

        // Set high threshold (24.0f) - New Max
        gameEngine.updateSettings(1000L, 500, false, false, 24.0f, 33.0f, 54.0f, true)
        
        // 7. SOFT (Force=25.0) -> > 24.0 (but < 33.0)
        gameEngine.processSwing(7000L, 25.0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        assertEquals(SwingType.SOFT_FLAT, gameEngine.gameState.value.lastSwingType)
    }
    @Test
    fun `test rally shrink logic`() {
        ...
        gameEngine.processSwing(3200L, 10f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
        ...
        gameEngine.updateSettings(1000L, baseWindow.toInt(), false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, false, GameMode.CLASSIC)
        ...
        repeat(36) { // We are at 4. Need 36 more to get to 40.
             // I hit
             gameEngine.processSwing(5000L + it*1000, 10f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
             // Opponent hits
    ...
    fun `test hit window scaling for slow serves`() {
        ...
        val baseFlightTime = 1000L
        gameEngine.updateSettings(baseFlightTime, baseHitWindow, false, false, GameEngine.DEFAULT_SOFT_THRESHOLD, GameEngine.DEFAULT_MEDIUM_THRESHOLD, GameEngine.DEFAULT_HARD_THRESHOLD, true)
        
        gameEngine.startGame()
        
        // Serve HARD_LOB (Slow, Modifier 2.5)
        val serveTime = 1000L
        gameEngine.processSwing(serveTime, 45f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 6.0f)
