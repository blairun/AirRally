...
class SoloRallyModeTest {
    ...
    fun `test solo rally longest rally update`() {
        ...
        gameEngine.processSwing(ballArrival, 25f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f)
    ...
    fun `test solo rally rematch reset`() {
        ...
        // Build up some state
        gameEngine.processSwing(1000L, 25f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f) // Serve
        val arrival = gameEngine.gameState.value.ballArrivalTimestamp
        gameEngine.processSwing(arrival, 25f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f) // Hit
