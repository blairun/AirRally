...
- **Rally Mode**: Full co-op game mode with:
  ...
  - HaPPy number sequence tier scoring (1, 7, 10, 13, 19, 23...) for steady progression (used to fibonacci which was a little to steep)
  - Line completion bonuses differentiated by type (Happy number offsets):
    - Horizontal (rows): 7, 10, 13, 19... (lowest)
    - Vertical (columns): 10, 13, 19, 23... (mid)
    - Diagonal: 13, 19, 23, 28... (highest)
